package com.example.myapplication17.bean;

import com.example.myapplication17.R;
...
public class GoodsInfo {
    ...
    private static String[] mNameArray = {
            "iPhone 12 ", "联想拯救者电竞手机Pro", "荣耀30 Pro", "雅迪电动车", "三星 Galaxy S20", "艾戈勒瑞士手表 ","松下微单相机","OnePlus 8 Pro "
    };
    // 声明一个手机商品的描述数组
    private static String[] mDescArray = {
            " Apple iPhone 12 mini (A2400) 64GB 黑色 手机 支持移动联通电信5G",
            "联想拯救者电竞手机Pro 12GB+128GB 骁龙865",
